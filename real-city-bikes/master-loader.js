(() => {
    ...
    if (!window.config.unityWebglLoaderUrl) {
        const t = window.config.unityVersion ? window.config.unityVersion.split(".") : []
            ...
            , o = t[1];
        if ("2019" === n)
            window.config.unityWebglLoaderUrl = 1 === o ? "https://game-cdn.poki.com/loaders/v2/unity/static/UnityLoader.2019.1.js" : "https://game-cdn.poki.com/loaders/v2/unity/static/UnityLoader.2019.2.js";
        else
