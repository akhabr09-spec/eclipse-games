const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/cat-from-hell-2[13]-mirraSDK[4.3.49].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/cat-from-hell-2[13]-mirraSDK[4.3.49].data.br",
            frameworkUrl: buildUrl + "/cat-from-hell-2[13]-mirraSDK[4.3.49].framework.js.br",
            codeUrl: buildUrl + "/cat-from-hell-2[13]-mirraSDK[4.3.49].wasm.br",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "Nolodin Games LLC",
            productName: "Cat From Hell 2",
